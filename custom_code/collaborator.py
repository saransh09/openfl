...
from dataloader import FedDataset
...
fl_experiment.prepare_workspace_distribution(model_provider=MI, task_keeper=TI, data_loader=fed_dataset, rounds_to_train=7, opt_treatment='CONTINUE_GLOBAL')
